...
#? Originally in datapiepliner/__init__.py as a check on source and sink filenames.
...
# if key is missing and not in datapipeliner/config_default.yaml, raise a descriptive
